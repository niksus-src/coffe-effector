...
const Popup: React.FC<props> = (props) => {
  ...
  useEffect(() => {
    console.log('loginsda', loginResult)
    if (!loginResult) sessionStorage.removeItem('isLogin')
    return () => {
      reset()
    }
  }, [])
            ...
            {actualAction && (
              <>
                ...
                <form className='register-form'>
                  <InputPopup nameIn='name' placeholder='Имя и фамилия' type='name' />
                  <InputPopup nameIn='mail' placeholder='Email' type='mail' />
                  <InputPopup nameIn='phone' placeholder='Телефон' type='phone' />
                  <InputPopup nameIn='password' placeholder='Пароль' type='password' />
                  <input
                    type='submit'
