...
const Basket = () => {
  ...
  for (let index = 0; index < 3; index++) {
    renderItems.push(<BasketItem key={index} />);
  }
      ...
      <div className="basket">
        ...
        <div className="block-wrapper basket-content">
          <div className="basket-content-top">
            <div className="basket-content-top-title">
              {renderItems.length} товара в корзине
            </div>
            <button className="basket-content-top-btn_delete_all">
              Удалить все
            </button>
          </div>
        ...
        <div className="block-wrapper delivery">
          ...
          <form className="delivery-form">
            ...
            <input
              type="submit"
              className={`delivery-form-btn_submit ${
                hasError() ? "disable" : null
              }`}
        ...
        <div className="basket-footer">
          <div className="block-wrapper basket-footer-promo">
            ...
            <div className="basket-footer-promo-desc">
              Введите подарочный промокод в поле ниже и получите скидку на заказ
              до 20%. Скидка не распространяется на доставку
            </div>
            <input
              type="text"
              placeholder="Промокод"
              className="basket-footer-promo-input"
            />
