        ...
        <div className="dignity">
            ...
            <div className="dignity-top">
                ...
                <div className="dignity-top-content">
                    <ul>
                        <li>
                            <img src={iconCoffe} alt="iconCoffe" className="dignity-li-marker" />
                            <div className="dignity-top-content-el-title">Всегда свежая обжарка</div>
                            <div className="dignity-top-content-el-desc">Подбор степени обжарки под каждый сорт кофе. Всегда свежая обжарка</div>
                        </li>
                        <li>
                            <img src={iconSale} alt="iconSale" className="dignity-li-marker" />
                            <div className="dignity-top-content-el-title">Лучшие цены на продукцию</div>
                            <div className="dignity-top-content-el-desc">Благодаря крупным объемам производства мы даем лучшие цены на нашу продукцию</div>
                        </li>
                        <li>
                            <img src={iconCons} alt="iconCons" className="dignity-li-marker" />
                            <div className="dignity-top-content-el-title">Консультации 24/7</div>
                            <div className="dignity-top-content-el-desc">Наши специалисты готовы всегда помочь 
                            и подсказать вам с выбором кофе или другой продукции.</div>
                        </li>
                    </ul>
                </div>
            </div>
